...
import {DeleteUserModalContent} from "../../components/DeleteUserModalContent/DeleteUserModalContent";
...
export const PrivateUserPage = ({onClick}) => {
    ...
    return <Container>
            ...
            <ModalOverlay onClick={onClick} shown={showModal} close={() => setShowModal(!showModal)} content={showRenameContent ? <RenameUserModalContent close={() => setShowModal(!showModal)} /> : <DeleteUserModalContent close={() => setShowModal(!showModal)} />}/>
        </Container>
}
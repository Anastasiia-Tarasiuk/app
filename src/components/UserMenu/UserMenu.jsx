...
export const UserMenu = ({modalSize, onClick}) => {
    ...
    return <Wrapper ref={ref}>
        ...
        {isShown && <Menu className="menu" onClick={e => onMenuClick(e)}>
            <MenuItem onClick={onClick} data-name="Rename">Rename</MenuItem>
            <MenuItem  onClick={onClick} data-name="Settings">Settings</MenuItem>
        </Menu>}

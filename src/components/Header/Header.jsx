...
import { HeaderWrapper, ToSearchButton, ToUserMenuButton} from "./Header.styled";
...
export const Header = () => {
    ...
    return <HeaderWrapper>
                ...
                <ButtonComponent className="logoutButton" type="button" text="Logout" onClick={onLogoutButtonClick} />
            </HeaderWrapper>
}